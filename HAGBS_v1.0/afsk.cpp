...
// The radio (class defined in Radio_Driver.h)
Radio* radio;
...
// HA-GBS function
void afsk_set_TX_chan(int chan){
  if(chan != radio->currentChannel){
    radio->set_TX_chan(chan);
  }
}
